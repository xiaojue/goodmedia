...
(function(W,G) {
	...
	map.prototype= {
			...
			if(google) {
					...
					if(that.type=="search") {
						...
						var errortime=0,markersArray=[],surname, //10次错误之后再给提示
							infowindow = new google.maps.InfoWindow(),T;
						...
						function postPostion() {
							...
							$.ajax({
								...
								success: function(data) {
									...
									google.maps.event.addListener(surname,'click',function(e){
										var lat=e['latLng']['Oa'],
											lng=e['latLng']['Pa'];
		...
		//baraction
		_baraction:function(){
			var diget=new Date().valueOf(),that=this,
