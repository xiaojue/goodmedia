			...
			exports: {
				init: function() {
					...
					$(function() {
						...
						//公告首尾相接
						$('.J_Roll').css('position', 'absolute').parent().css({
							'overflow': 'hidden',
							'width': 181,
							'position': 'relative'
						});
						...
						parentWidth = 181,
						cloneDOM = $('.J_Roll>span:first').clone(),
						timer,
						nowleft = 0;
				...
				backtop: function() {
					$(function() {
						G.widget.use('backtop', function(widget) {
                var backtoptemp = "<div id='J_Backtop' style='cursor:pointer;'><img src='http://s1.ifiter.com/static/images/back_top.png' title='返回顶部'></div>";
              $('body').append(backtoptemp);
							G.widget.backtop("#J_Backtop", {
								right: 0,
								bottom: 0
							});
						});
